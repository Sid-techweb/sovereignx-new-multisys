...
class TestGatewayArchitecture(unittest.TestCase):
    ...
    def test_grounded_query_success(self, mock_generate, mock_get_embedding, mock_retrieve):
        ...
        mock_generate.return_value = "Pump P-204 experienced abnormal discharge pressure."
        ...
        with patch.object(settings, "MODEL_PROVIDER", "ollama"):
            ...
            self.assertEqual(data["answer"], "Pump P-204 experienced abnormal discharge pressure.")
            ...
            self.assertIn("STRICT WRITING & CITATION RULES", call_args["system_prompt"])
