...
DOCUMENT_RAG_CHAT_SYSTEM_PROMPT = (
    ...
    "source of truth for anything they cover.\n\n"
    "Write your response in clean, professional natural language. Do NOT embed raw "
    "metadata, document IDs, chunk IDs, page indices, or bracketed [Source: ...] tags "
    "inside your response text. The UI presents source document citations separately.\n\n"
