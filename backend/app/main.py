...
from app.api import health, models, agents, documents, rag, tools, reports, sovereignty, cases, chat, investigations, auth
from app.api.auth import verify_api_key, get_current_user_or_api_key
...
app.include_router(models.router, dependencies=[Depends(get_current_user_or_api_key)])
app.include_router(agents.router, dependencies=[Depends(get_current_user_or_api_key)])
app.include_router(documents.router, dependencies=[Depends(get_current_user_or_api_key)])
app.include_router(rag.router, dependencies=[Depends(get_current_user_or_api_key)])
app.include_router(tools.router, dependencies=[Depends(get_current_user_or_api_key)])
app.include_router(reports.router, dependencies=[Depends(get_current_user_or_api_key)])
app.include_router(cases.router, dependencies=[Depends(get_current_user_or_api_key)])
app.include_router(investigations.router, dependencies=[Depends(get_current_user_or_api_key)])
app.include_router(chat.router, dependencies=[Depends(get_current_user_or_api_key)])
